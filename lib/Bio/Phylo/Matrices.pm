...
Bio::Phylo::Matrices inherits from one or more superclasses. This means that objects of 
class Bio::Phylo::Matrices also "do" the methods from the superclasses in addition to the 
...
Bio::Phylo::Matrices inherits from superclass L<Bio::Phylo::Listable>. 
...
Bio::Phylo::Matrices inherits from superclass L<Bio::Phylo::Util::XMLWritable>. 
Below are the public methods (if any) from this superclass.
...
Bio::Phylo::Matrices inherits from superclass L<Bio::Phylo>. 
Below are the public methods (if any) from this superclass.
