...
More documentation can be found as embedded documentation in the classes
of this release. Note that Bio::Phylo uses inheritance to a large extent,
...
section of that class's documentation.
...
Bio::Phylo superclasses of object Bio::Phylo::Forest::Node has a
...
aspects of BioPerl (L<http://www.bioperl.org>), L<Bio::NEXUS> and the CIPRES project
(L<http://www.phylo.org>). Refer to the L<Bio::ObjectCompat> document for
...
I know what version you're using:
 ...
 $Id: Manual.pod 3396 2007-03-26 18:08:40Z rvosa $
