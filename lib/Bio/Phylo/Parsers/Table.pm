...
Bio::Phylo::Parsers::Table inherits from one or more superclasses. This means that objects of 
class Bio::Phylo::Parsers::Table also "do" the methods from the superclasses in addition to the 
...
Bio::Phylo::Parsers::Table inherits from superclass L<Bio::Phylo::IO>. 
