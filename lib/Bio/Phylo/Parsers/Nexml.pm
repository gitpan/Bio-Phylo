...
Bio::Phylo::Parsers::Nexml inherits from one or more superclasses. This means that objects of 
class Bio::Phylo::Parsers::Nexml also "do" the methods from the superclasses in addition to the 
...
Bio::Phylo::Parsers::Nexml inherits from superclass L<Bio::Phylo::IO>. 
