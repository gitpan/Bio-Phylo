...
Bio::Phylo::Parsers::Nexus inherits from one or more superclasses. This means that objects of 
class Bio::Phylo::Parsers::Nexus also "do" the methods from the superclasses in addition to the 
...
Bio::Phylo::Parsers::Nexus inherits from superclass L<Bio::Phylo::IO>. 
