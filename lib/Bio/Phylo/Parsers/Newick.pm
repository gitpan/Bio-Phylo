...
# AUTOGENERATED pod created by /Users/rvosa/Applications/podinherit on Wed Mar  4 17:13:55 2009
...
Bio::Phylo::Parsers::Newick inherits from one or more superclasses. This means that objects of 
class Bio::Phylo::Parsers::Newick also "do" the methods from the superclasses in addition to the 
...
Bio::Phylo::Parsers::Newick inherits from superclass L<Bio::Phylo::IO>. 
