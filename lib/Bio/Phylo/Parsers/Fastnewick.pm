...
Bio::Phylo::Parsers::Fastnewick - Parses newick trees. No serviceable parts
inside.
...
don't call it directly. It is different from
L<Bio::Phylo::Parsers::Newick> in that it does not
add unique labels to internal nodes (it does respect
the ones that are already there, though) and it is
about four times faster. However, it is not considered
'stable', yet (i.e. there might be bugs).
...
=begin comment
 ...
 Function: Initializes a Bio::Phylo::Parsers::Fastnewick object.
 Returns : A Bio::Phylo::Parsers::Fastnewick object.
 Args    : none.
