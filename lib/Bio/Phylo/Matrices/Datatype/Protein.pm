...
# AUTOGENERATED pod created by /Users/rvosa/Applications/podinherit on Wed Mar  4 17:13:51 2009
...
Bio::Phylo::Matrices::Datatype::Protein inherits from one or more superclasses. This means that objects of 
class Bio::Phylo::Matrices::Datatype::Protein also "do" the methods from the superclasses in addition to the 
...
Bio::Phylo::Matrices::Datatype::Protein inherits from superclass L<Bio::Phylo::Matrices::Datatype>. 
...
Bio::Phylo::Matrices::Datatype::Protein inherits from superclass L<Bio::Phylo::Util::XMLWritable>. 
Below are the public methods (if any) from this superclass.
...
Bio::Phylo::Matrices::Datatype::Protein inherits from superclass L<Bio::Phylo>. 
Below are the public methods (if any) from this superclass.
